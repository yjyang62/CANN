...
/*!
 * \file aclnn_matmul_all_to_all_v2.h
 * \brief
 */
#ifndef OP_API_INC_MATMUL_ALL_TO_ALL_V2_
#define OP_API_INC_MATMUL_ALL_TO_ALL_V2_
 ...
 * @brief aclnnMatmulAlltoAllV2的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnMatmulAlltoAllV2GetWorkspaceSize(
...
/**
 * @brief aclnnMatmulAlltoAllV2的第二段接口，用于执行计算。
 * @param [in] workspace: 在Device侧申请的workspace内存地址。
 * @param [in] workspacesize: 在Device侧申请的workspace大小，由第一段接口aclnnMatmulAlltoAllV2GetWorkspaceSize获取。
...
#endif // OP_API_INC_MATMUL_ALL_TO_ALL_V2_