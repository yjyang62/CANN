...
  */
#ifndef OP_API_INC_ALL_TO_ALLV_GROUPED_MATMUL_V2_
#define OP_API_INC_ALL_TO_ALLV_GROUPED_MATMUL_V2_
 ...
 * @brief aclnnAlltoAllvGroupedMatMulV2的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 * @param [in] commMode: 计算输入，str。通信引擎参数，指定当前通信类型，支持输入""、"aicpu"和"ccu"
 ...
 * A = recvCounts的累加和;
 */
ACLNN_API aclnnStatus aclnnAlltoAllvGroupedMatMulV2GetWorkspaceSize(const aclTensor *gmmX, const aclTensor *gmmWeight,
 ...
 * @param [in] workspace_size: 在npu device侧申请的workspace大小，由第一段接口aclnnAlltoAllvGroupedMatMulV2GetWorkspaceSize获取。
 * @param [in] executor: op执行器，包含了算子计算流程。
 * @param [in] stream: acl stream流。
 * @return aclnnStatus: 返回状态码
 */
ACLNN_API aclnnStatus aclnnAlltoAllvGroupedMatMulV2(void* workspace, uint64_t workspaceSize,
...
#endif  // OP_API_INC_ALL_TO_ALLV_GROUPED_MATMUL_V2_