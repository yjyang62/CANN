...
// hccl comm mode
#define TPL_HCCL_COMM_MODE uint8_t HCCL_COMM_MODE
...
// hccl Server communication mode uint8_t
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(HCCL_COMM_MODE, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, \
                        HCCL_COMM_MODE_CCU, HCCL_COMM_MODE_AICPU),
);
