...
/*!
 * \file quant_reduce_scatter_v2_def.cpp
 * \brief 算子信息库定义
 */
#include <register/op_def_registry.h>

namespace ops {
class QuantReduceScatterV2 : public OpDef {
public:
    explicit QuantReduceScatterV2(const char *name) : OpDef(name)
    {
        this->Input("context")
            .ParamType(REQUIRED)
