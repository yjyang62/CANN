...
/*!
 * \file moe_distribute_dispatch_setup_tiling_arch22.h
 * \brief
 */

#ifndef MOE_DISTRIBUTE_DISPATCH_SETUP_TILING_Arch22_H_
#define MOE_DISTRIBUTE_DISPATCH_SETUP_TILING_Arch22_H_
...
#endif // MOE_DISTRIBUTE_DISPATCH_SETUP_TILING_Arch22_H_