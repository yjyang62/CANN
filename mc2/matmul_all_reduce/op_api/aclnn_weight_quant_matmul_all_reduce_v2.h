...
/*!
 * \file aclnn_weight_quant_matmul_all_reduce_v2.h
 * \brief
 */
#ifndef OP_API_INC_WEIGHT_QUANT_MATMUL_ALL_REDUCE_V2_
#define OP_API_INC_WEIGHT_QUANT_MATMUL_ALL_REDUCE_V2_
...
/**
 * @brief aclnnWeightQuantMatmulAllReduceV2的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 */
ACLNN_API aclnnStatus aclnnWeightQuantMatmulAllReduceV2GetWorkspaceSize(
...
/**
 * @brief aclnnWeightQuantMatmulAllReduceV2的第二段接口，用于执行计算。
 * @param [in] workspace: 在npu device侧申请的workspace内存起址。
 * @param [in] workspace_size: 在npu
 * device侧申请的workspace大小，由第一段接口aclnnWeightQuantMatmulAllReduceV2GetWorkspaceSize获取。
 * @param [in] executor: op执行器，包含了算子计算流程。
 * @param [in] stream: acl stream流。
 * @return aclnnStatus: 返回状态码
 */
ACLNN_API aclnnStatus aclnnWeightQuantMatmulAllReduceV2(
...
#endif // OP_API_INC_WEIGHT_QUANT_MATMUL_ALL_REDUCE_V2_