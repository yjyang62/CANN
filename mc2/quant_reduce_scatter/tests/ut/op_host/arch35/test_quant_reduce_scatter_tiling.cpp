...
static QuantReduceScatterTestParam g_testCases[] = {
    ...
    ge::GRAPH_SUCCESS, 0UL, "1024 5120 80 64 314572800 4398046514176 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    ge::GRAPH_SUCCESS, 0UL, "2048 5120 40 64 314572800 4398046517248 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    "group", "sum", ge::DT_FLOAT16, 8, "3510",
    ge::GRAPH_SUCCESS, 0UL, "1024 7168 56 64 314572800 4398046515200 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    "group", "sum", ge::DT_FLOAT16, 8, "3510",
    ge::GRAPH_SUCCESS, 0UL, "1024 4096 64 64 314572800 4398046513152 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    "group", "sum", ge::DT_FLOAT, 8, "3510",
    ge::GRAPH_SUCCESS, 0UL, "2048 4096 32 64 314572800 4398046516224 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    "group", "sum", ge::DT_FLOAT16, 8, "3510",
    ge::GRAPH_SUCCESS, 0UL, "1024 8192 64 64 314572800 4398046516224 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    {"quant_reduce_scatter_critical_case_rank2_mx",
     ...
     ge::GRAPH_SUCCESS, 0UL, "1024 5120 80 64 314572800 4398046524416 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_rank4_tg",
     {1024, 5120}, ge::DT_INT8, ge::FORMAT_ND,
     {1024, 40}, ge::DT_FLOAT, ge::FORMAT_ND,
     {256, 5120}, ge::DT_FLOAT16, ge::FORMAT_ND,
     "group", "sum", ge::DT_FLOAT16, 4, "3510",
     ge::GRAPH_SUCCESS, 0UL, "1024 5120 40 64 314572800 4398046517248 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_H1024_tg",
     ...
     "group", "sum", ge::DT_FLOAT16, 8, "3510",
     ge::GRAPH_SUCCESS, 0UL, "1024 1024 8 64 314572800 4398046513152 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_H8192_mx",
     ...
     {128, 8192}, ge::DT_FLOAT16, ge::FORMAT_ND,
     "group", "sum", ge::DT_FLOAT16, 8, "3510",
     ge::GRAPH_SUCCESS, 0UL, "1024 8192 128 64 314572800 4398046516224 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    {"quant_reduce_scatter_critical_case_3d_tg_int8_float_out",
     ...
     "group", "sum", ge::DT_FLOAT, 8, "3510",
     ge::GRAPH_SUCCESS, 0UL, "1024 5120 40 64 314572800 4398046514176 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    ...
    {"quant_reduce_scatter_critical_case_3d_tg_rank2",
     ...
     {512, 5120}, ge::DT_FLOAT16, ge::FORMAT_ND,
     "group", "sum", ge::DT_FLOAT16, 2, "3510",
     ge::GRAPH_SUCCESS, 0UL, "1024 5120 40 64 314572800 4398046524416 0 ", {16777216}, MC2_TILING_DATA_RESERVED_LEN},
    // --- 新增异常路径用例 ---
