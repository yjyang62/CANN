...
/*!
 * \file aclnn_allto_all_matmul_v2.h
 * \brief
 */
#ifndef OP_API_INC_ALL_TO_ALL_MATMUL_V2_
#define OP_API_INC_ALL_TO_ALL_MATMUL_V2_
 ...
 * @brief aclnnAlltoAllMatMulV2的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnAlltoAllMatmulV2GetWorkspaceSize(
...
/**
 * @brief aclnnAlltoAllMatMulV2的第二段接口，用于执行计算。
 * @param [in] workspace: 在Device侧申请的workspace内存地址。
 * @param [in] workspacesize: 在Device侧申请的workspace大小，由第一段接口aclnnAlltoAllMatMulV2GetWorkspaceSize获取。
 * @param [in] executor: op执行器，包含了算子计算流程。
 * @param [in] stream: 指定执行任务的Stream。
 * @return aclnnStatus: 返回状态码
 */
__attribute__((visibility("default"))) aclnnStatus aclnnAlltoAllMatmulV2(void *workspace, uint64_t workspaceSize,
