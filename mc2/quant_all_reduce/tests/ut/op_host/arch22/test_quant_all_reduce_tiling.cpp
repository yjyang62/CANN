...
// setup & teardown
class QuantAllReduceArch22TilingTest : public testing::TestWithParam<QuantAllReduceTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "QuantAllReduceArch22TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "QuantAllReduceArch22TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(QuantAllReduceArch22TilingTest, GeneralCases)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(QuantAllReduceArch22TilingTest, GeneralCasesMultiThread)
{
