...
#include "../../../op_api/aclnn_moe_distribute_combine_v4.h"
...
namespace MoeDistributeCombineV4 {
namespace {
...
class L2MoeDistributeCombineV4Test : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        cout << "L2MoeDistributeCombineV4Test SetUp" << endl;
    }

    static void TearDownTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        cout << "L2MoeDistributeCombineV4Test TearDown" << endl;
    }
};

TEST_F(L2MoeDistributeCombineV4Test, TestMoeDistributeCombineV4FirstApi)
{
...
TEST_F(L2MoeDistributeCombineV4Test, TestMoeDistributeCombineV4ExecuteEntry)
{
    aclnnStatus ret = aclnnMoeDistributeCombineV4(nullptr, 0, nullptr, nullptr);
