...
/*!
 * \file vf_softmax_unaligned128_no_update.h
 * \brief
 */
#ifndef VF_SOFTMAX_UNALIGNED128_NO_UPDATE_H
#define VF_SOFTMAX_UNALIGNED128_NO_UPDATE_H
...
__simd_vf__ void ProcessVec1NoUpdateGeneralImpl128VF(
    __ubuf__ T2 * expUb, __ubuf__ T2 * x_expUb, __ubuf__ T * expSumUb,
    __ubuf__ T * maxUb, __ubuf__ T * maxUbStart, __ubuf__ T * srcUb,
    ...
    const T scale, const T minValue)
{
    ...
    ProcessVec1NoUpdateGeneralImpl128VF<T, T2, s1BaseSize, s2BaseSize, hasAttn>(
        expUb, x_expUb, expSumUb, maxUb, maxUbStart, srcUb, indexesUb, maskUb, maskUbUnroll,
        nPadding, blockStride, repeatStride, oriTailN, tailN, scale, pltOriTailN, pltTailN, m, scale, minValue);
}
#endif
} // namespace

#endif // VF_SOFTMAX_UNALIGNED128_NO_UPDATE_H
