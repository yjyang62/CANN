...
/*!
 * \file vf_softmax_aligned128_no_update.h
 * \brief
 */
#ifndef VF_SOFTMAX_ALIGNED128_NO_UPDATE_H
#define VF_SOFTMAX_ALIGNED128_NO_UPDATE_H
    ...
    const T scale, const T minValue)
{
    ...
    ProcessVec1NoUpdateImpl128VF<T, T2, s1BaseSize, s2BaseSize, hasAttn>(
        expUb, x_expUb, expSumUb, maxUb, maxUbStart, srcUb, indexesUb, maskUb, maskUbUnroll,
        blockStride, repeatStride, scale, m, scale, minValue);
}
#endif
} // namespace

#endif // VF_SOFTMAX_ALIGNED128_NO_UPDATE_H
