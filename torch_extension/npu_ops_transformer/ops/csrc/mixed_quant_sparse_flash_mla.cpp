...
std::tuple<at::Tensor, at::Tensor> npu_mixed_quant_sparse_flash_mla(
    const at::Tensor &q,
...
{
    m.def("npu_mixed_quant_sparse_flash_mla", &npu_mixed_quant_sparse_flash_mla, "npu_mixed_quant_sparse_flash_mla");
}
} // namespace op_api