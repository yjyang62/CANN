...
if _TORCHAIR_AVAILABLE:
    @register_fx_node_ge_converter(torch.ops.cann_ops_transformer.lightning_indexer_metadata.default)
    def convert_lightning_indexer_metadata(
        num_heads_q: int, num_heads_kv: int, head_dim: int, topk: int, *,
        ...
        raise RuntimeError("GE converter doesn't support op: 'lightning_indexer_metadata'")
