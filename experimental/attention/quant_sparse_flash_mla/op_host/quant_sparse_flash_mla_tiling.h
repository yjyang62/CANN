...
/*!
 * \file quant_sparse_flash_mla_tiling.h
 * \brief
 */
#ifndef QUANT_SPARSE_FLASH_MLA_TILING_H
#define QUANT_SPARSE_FLASH_MLA_TILING_H
...
// -----------算子TilingData定义---------------
BEGIN_TILING_DATA_DEF(QuantSparseFlashMlaBaseParams)
...
BEGIN_TILING_DATA_DEF(QuantSparseFlashMlaTilingData)
TILING_DATA_FIELD_DEF_STRUCT(QuantSparseFlashMlaBaseParams, baseParams);
END_TILING_DATA_DEF

REGISTER_TILING_DATA_CLASS(QuantSparseFlashMla, QuantSparseFlashMlaTilingData)
...
private:
    ...
    QuantSparseFlashMlaTilingData tilingData_;
