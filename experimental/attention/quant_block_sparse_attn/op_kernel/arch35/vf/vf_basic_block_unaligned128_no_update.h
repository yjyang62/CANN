...
__simd_vf__ void ProcessVec1NoUpdateGeneralImpl128VF(
    __ubuf__ T2 *expUb, __ubuf__ T2 *x_expUb, __ubuf__ T *expSumUb, __ubuf__ T *maxUb, __ubuf__ T *maxUbStart,
    __ubuf__ T *srcUb, __ubuf__ T *qScaleUb, __ubuf__ uint8_t *indexesUb, __ubuf__ uint32_t *maskUb,
    __ubuf__ uint32_t *maskUbUnroll, const uint32_t nPadding, const uint32_t blockStride, const uint32_t repeatStride,
    const uint32_t oriTailN, const uint32_t tailN, const float dScale, uint32_t pltOriTailN, uint32_t pltTailN,
    float divValue, const uint16_t m, const T scale, const float dScaleQK, const T minValue,
    ...
    const float deSCaleKValue = 1.0f, const float pScale = 1.0f)
{
    ...
    ProcessVec1NoUpdateGeneralImpl128VF<T, T2, s1BaseSize, s2BaseSize, hasAtten, isMlaSgd>(
        expUb, x_expUb, expSumUb, maxUb, maxUbStart, srcUb, qScaleUb, indexesUb, maskUb, maskUbUnroll, nPadding,
        blockStride, repeatStride, oriTailN, tailN, dScale, pltOriTailN, pltTailN, divValue, m, scale, dScaleQK,
