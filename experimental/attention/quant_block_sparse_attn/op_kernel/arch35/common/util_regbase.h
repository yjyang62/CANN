...
#define COMMON_RUN_INFO \
    ...
    int64_t sparseBase = 0; /* BSA: sparseIndices 当前 (b,n2,g,qb) 基址 */ \
    int64_t sparseS2TokenOffset = 0; /* BSA: sparseIndices 映射后的 actual KV token offset */ \
    int32_t actSparseLen = 0; /* BSA: sparseSeqLen 当前实际选块数 */ \
