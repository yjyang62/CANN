...
#ifndef __MHC_POST_BACKWARD_TILING_KEY_ARCH35_H__
#define __MHC_POST_BACKWARD_TILING_KEY_ARCH35_H__
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_TILING_STRUCT_SEL(MhcPostBackwardTilingDataArch35)
    )
);
