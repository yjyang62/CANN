...
/*!
 * \file inplace_rotate_interleaved_split_s_mixed.h
 * \brief
 */
#ifndef INPLACE_ROTATE_INTERLEAVED_SPLIT_S_MIXED_H
#define INPLACE_ROTATE_INTERLEAVED_SPLIT_S_MIXED_H
...
template <typename T>
__aicore__ inline void InterleavedSplitSMixed<T>::InitData(const InplacePartialRopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
...
#endif // INPLACE_ROTATE_INTERLEAVED_SPLIT_S_MIXED_H
