...
/*!
 * \file inplace_rotate_interleaved_split_bs_pad.h
 * \brief
 */
...
template <typename T>
__aicore__ inline void InterleavedSplitBSPad<T>::InitData(const InplacePartialRopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
