...
/*!
 * \file inplace_rotate_interleaved_split_bsn_pad.h
 * \brief
 */
...
template <typename T>
__aicore__ inline void InterleavedSplitBSNPad<T>::InitData(const InplacePartialRopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
