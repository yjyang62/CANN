...
/*!
 * \file inplace_rotate_interleaved_split_bsn_pad_mixed.h
 * \brief
 */
#ifndef INPLACE_ROTATE_INTERLEAVED_SPLIT_BSN_PAD_MIXED_H
#define INPLACE_ROTATE_INTERLEAVED_SPLIT_BSN_PAD_MIXED_H
...
template <typename T>
__aicore__ inline void InterleavedSplitBSNPadMixed<T>::InitData(const InplacePartialRopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
...
#endif // INPLACE_ROTATE_INTERLEAVED_SPLIT_BSN_PAD_MIXED_H
