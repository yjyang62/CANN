...
/*!
 * \file inplace_rotate_interleaved_split_bs_pad_mixed.h
 * \brief
 */
#ifndef INPLACE_ROTATE_INTERLEAVED_SPLIT_BS_PAD_MIXED_H
#define INPLACE_ROTATE_INTERLEAVED_SPLIT_BS_PAD_MIXED_H
...
template <typename T>
__aicore__ inline void InterleavedSplitBSPadMixed<T>::InitData(const InplacePartialRopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
...
#endif // INPLACE_ROTATE_INTERLEAVED_SPLIT_BS_PAD_MIXED_H
