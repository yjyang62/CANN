...
/*!
 * \file rotary_position_embedding_ab_mixed.h
 * \brief Mixed precision kernel for AB layout: x is half/bfloat16, cos/sin are float
 */
#ifndef ROTARY_POSITION_EMBEDDING_AB_MIXED_H
#define ROTARY_POSITION_EMBEDDING_AB_MIXED_H
...
#endif  // ROTARY_POSITION_EMBEDDING_AB_MIXED_H
