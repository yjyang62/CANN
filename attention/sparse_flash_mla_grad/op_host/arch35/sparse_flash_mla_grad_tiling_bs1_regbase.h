...
/*!
 * \file sparse_flash_mla_grad_tiling_bs1_regbase.h
 * \brief
 */
...
#include "../../op_kernel/arch35/sparse_flash_mla_grad_tiling_data_regbase.h"
#include "../../op_kernel/arch35/sparse_flash_mla_grad_template_tiling_key.h"
...
struct TempParams {
    ...
    uint32_t cmp_selected_block_count;
    ...
    bool oriKV = false;
    bool cmpKV = false;
    bool oriKVSparse = false;
    bool cmpKVSparse = false;
    bool usedSeqQ = false;
...
private:
    ...
    ge::graphStatus GetOriWinToken(int64_t oriMaskMode);
