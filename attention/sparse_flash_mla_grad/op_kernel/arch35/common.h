...
struct FagConstInfo {
    ...
    int64_t mm3Ka;
    int64_t mm4Kb;
    int64_t dRopeSize = 0; // rope旋转的维度
    int64_t dTotalSize;

    int64_t selectedBlockCount = 2048;
    int64_t oriSelectedBlockCount = 2048; // K1
    int64_t cmpSelectedBlockCount = 2048; // K2

    int64_t actualOriSelectedBlockCount = 2048; // Min(K1, S2)
    int64_t actualCmpSelectedBlockCount = 2048; // Min(K2, S3)
