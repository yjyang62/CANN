...
class FusedFloydAttentionTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "FusedFloydAttentionTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "FusedFloydAttentionTest TearDown" << std::endl;
    }
};

TEST_F(FusedFloydAttentionTest, fused_floyd_attention_infer_dtype_fp16)
{
    gert::InfershapeContextPara infershapeContextPara("FusedFloydAttention",
    { // input info
    ...
    std::vector<std::vector<int64_t>> expectOutputShape = {{2, 4, 16, 256, 8}, {2, 4, 16, 256, 8}, {2, 4, 16, 256, 128}};
    ExecuteTestCase(infershapeContextPara, ge::GRAPH_SUCCESS, expectOutputShape);
}

TEST_F(FusedFloydAttentionTest, fused_floyd_attention_infer_dtype_bf16)
{
    gert::InfershapeContextPara infershapeContextPara("FusedFloydAttention",
    { // input info
