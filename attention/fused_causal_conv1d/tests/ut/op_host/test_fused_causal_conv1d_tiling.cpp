    ...
    bool inplace = false)
{
    return {
        ...
        {"inplace",             Ops::Transformer::AnyValue::CreateFrom<bool>(inplace)},
    };
}
...
TEST_F(FusedCausalConv1dCutBHTiling, bh_3d_bf16_b4_s1_d512)
{
    ...
    auto a = MakeAttrs(0, -1, 0, 1, 0, 128, 0, false);
...
{
    optiling::FusedCausalConv1dCutBHCompileInfo c = {64, 261888};
    auto a = MakeAttrs(0, -1, 0, 4, 0, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
{
    optiling::FusedCausalConv1dCutBHCompileInfo c = {64, 261888};
    auto a = MakeAttrs(0, -1, 0, 8, 0, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
TEST_F(FusedCausalConv1dCutBHTiling, bh_2d_inplace_fp16_b4_s16_d512)
{
    optiling::FusedCausalConv1dCutBHCompileInfo c = {64, 261888};
    auto a = MakeAttrs(0, -1, 0, 4, 0, 128, 0, true);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
            {{{16, 512}, {16, 512}},       ge::DT_FLOAT16, ge::FORMAT_ND}, // x
            {{{3, 512}, {3, 512}},         ge::DT_FLOAT16, ge::FORMAT_ND}, // weight
...
{
    optiling::FusedCausalConv1dCutBHCompileInfo c = {64, 261888};
    auto a = MakeAttrs(0, -1, 0, 4, 0, 128, 1, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
            {{{16, 512}, {16, 512}},       ge::DT_FLOAT16, ge::FORMAT_ND}, // x
            {{{3, 512}, {3, 512}},         ge::DT_FLOAT16, ge::FORMAT_ND}, // weight
...
{
    optiling::FusedCausalConv1dCutBHCompileInfo c = {64, 261888};
    auto a = MakeAttrs(0, -1, 0, 4, 1, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
            {{{16, 512}, {16, 512}},       ge::DT_FLOAT16, ge::FORMAT_ND}, // x
            {{{3, 512}, {3, 512}},         ge::DT_FLOAT16, ge::FORMAT_ND}, // weight
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 256, 0, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 64, 0, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 200, 0, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 15, 0, 86, 1, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 27, 0, 234, 1, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
TEST_F(FusedCausalConv1dCutBSHTiling, bsh_noNAT_noapc_inplace_fp16_b12_s300_d512)
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 300, 0, 128, 0, true);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
        ...
        {
            {{{300, 512}, {300, 512}}, ge::DT_FLOAT16, ge::FORMAT_ND},        // y
            {{{24, 2, 512}, {24, 2, 512}}, ge::DT_FLOAT16, ge::FORMAT_ND},    // convStates
        },
        a, &ci);
    ExecuteTestCase(p, ge::GRAPH_SUCCESS, 10001,
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 128, 1, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
...
{
    BshCompileInfo ci;
    auto a = MakeAttrs(0, -1, 0, 128, 0, 128, 0, false);
    gert::TilingContextPara p("FusedCausalConv1d",
        {
