...
| PyTorch API | - | 通过[torch.ops.cann_ops_transformer.lightning_indexer_metadata](../../torch_extension/cann_ops_transformer/docs/zh/lightning_indexer.md)接口调用LightningIndexerV2Metadata算子。|
