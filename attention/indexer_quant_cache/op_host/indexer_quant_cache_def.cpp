...
/*!
 * \file indexer_quant_cache_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class IndexerQuantCache : public OpDef {
public:
    explicit IndexerQuantCache(const char* name) : OpDef(name)
    {
        this->Input("cache")
            .ParamType(REQUIRED)
