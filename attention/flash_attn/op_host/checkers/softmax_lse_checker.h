...
#ifndef FLASH_ATTN_SOFTMAX_LSE_CHECKER_H
#define FLASH_ATTN_SOFTMAX_LSE_CHECKER_H
...
class SoftmaxLSEChecker : public FABaseChecker {
public:
...
#endif // FLASH_ATTN_SOFTMAX_LSE_CHECKER_H