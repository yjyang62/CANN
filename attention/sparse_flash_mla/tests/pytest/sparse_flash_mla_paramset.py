...
TEST_PARAMS = {
    ...
    "csa_g32_test_prefill":{
        "testcase_name": ["csa_g32_test_prefill"],
        "layout_q": ["TND"],
        "layout_kv": ["PA_BBND"],
        "q_type": [torch.bfloat16],
        "ori_kv_type": [torch.bfloat16],
        ...
        "block_size2": [128],
        "cu_seqlens_q": [[0, 2]],
        "cu_seqlens_ori_kv": [[0, 256]],
        "cu_seqlens_cmp_kv": [[0, 64]],
        "seqused_ori_kv": [[256]],
        "seqused_cmp_kv": [[64]],
        "cmp_residual_kv": [[0]],
        "softmax_scale": [0.04419417],
    ...
    "csa_g16_test_prefill":{
        "testcase_name": ["csa_g16_test_prefill"],
        "layout_q": ["TND"],
        "layout_kv": ["PA_BBND"],
        "q_type": [torch.bfloat16],
        "ori_kv_type": [torch.bfloat16],
    ...
    "swa_g16_test_prefill":{
        "testcase_name": ["swa_g16_test_prefill"],
        "layout_q": ["TND"],
        "layout_kv": ["PA_BBND"],
        "q_type": [torch.bfloat16],
        "ori_kv_type": [torch.bfloat16],
